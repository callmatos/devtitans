...
const char* ssid = "wifi-charles"; //ICOMP_1A
const char* password = "charless"; //1comp@14#
...
// Function callback (Subscribe) to ESP32 that will receive.
...
void setup() {
  pinMode(LED1_Pin, OUTPUT);     // Initialize the LED pin as an output
